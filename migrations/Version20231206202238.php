 ...
 */
final class Version20231206202238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE date_heure date_heure DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis CHANGE date_heure date_heure VARCHAR(255) NOT NULL');
